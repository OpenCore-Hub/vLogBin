...
export const authConfig = {
  ...
  zitadel: {
    ...
    instanceHost: str(process.env.ZITADEL_INSTANCE_HOST),
    publicHost: str(process.env.ZITADEL_PUBLIC_HOST),
    customRequestHeaders: str(process.env.CUSTOM_REQUEST_HEADERS),
