...
export function LogoMark({ size = 24, ...props }: IconProps) {
  return (
    ...
    >
      ...
      />
      <path
        d="M12 20 8.4 12.8M12 20l3.6-7.2"
        stroke="currentColor"
        strokeWidth={2.4}
        strokeLinecap="round"
        strokeLinejoin="round"
...
export const EyeOffIcon = (p: IconProps) => (
  <Svg {...p}>
    <path d="M10.7 5.1A10.5 10.5 0 0 1 12 5c6.5 0 10 7 10 7a17.6 17.6 0 0 1-2.2 3.2M6.6 6.6A17 17 0 0 0 2 12s3.5 7 10 7c1.7 0 3.2-.5 4.5-1.3" />
