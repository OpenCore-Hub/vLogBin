...
export function TerminalHero({ className }: { className?: string }) {
  return (
    <div
      className={cn(
        "relative overflow-hidden rounded-xl border border-white/10 bg-terminal-bg shadow-lg",
        className,
      )}
      role="img"
    ...
    >
      ...
      {/* 底部状态条 */}
      <div className="flex items-center gap-2 border-t border-white/10 px-4 py-2 font-mono text-[11px] text-terminal-muted">
