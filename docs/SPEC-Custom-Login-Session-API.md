...
> 实现状态：P0/P1/P2/P3 完成（登录名/密码、TOTP、OTP email/SMS、Passkey/U2F、账号选择器、加密 flow/session cookie、OIDC 代理、注册/邮箱验证/Passkey 初始化/MFA 跳过/IDP 回退、基础设施故障自动回退）；剩余 P4 真实 ZITADEL 联调、E2E 与灰度待续。
